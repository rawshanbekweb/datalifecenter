...
export default function Loader(): React.ReactElement {
  return (
    <m.div initial={{ opacity:1 }} animate={{ opacity:0 }} transition={{ duration:0.6, delay:1.6 }}
      ...
      <m.div animate={{ scale:[1,1.08,1] }} transition={{ duration:1, repeat:1 }}
        style={{ width:64, height:64, borderRadius:18, overflow:'hidden', boxShadow:'0 8px 32px rgba(14,165,233,0.3)' }}>
        <img src="/assets/favicon.jpg" alt="DATA LIFE" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
      </m.div>
