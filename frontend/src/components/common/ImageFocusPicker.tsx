      ...
      <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
          ...
          {/* Bosh sahifadagi yirik karta bilan AYNAN bir xil chiziladi
              ...
              va gorizontal siljish `transform` bo'lib tushadi. Avval bu yerda
              `cover` ishlatilardi — admin ko'rgan natija saytdagidan boshqa
              edi. Vertikal fokus bu kadrda ATAYIN ta'sir qilmaydi (chapdagi
              dumaloq ko'rinishda esa qiladi) — `imageFocus.ts` ga qarang. */}
          <figure style={{ textAlign: 'center' }}>
            <div style={{ position: 'relative', width: 76, height: 95, borderRadius: 10, overflow: 'hidden', border: '2px solid #e2e8f0', background: 'linear-gradient(180deg,#f1f5f9 0%,#e2e8f0 100%)' }}>
              <span style={{ position: 'absolute', inset: 0, transform: focusPanX({ focusX, focusY }) }}>
