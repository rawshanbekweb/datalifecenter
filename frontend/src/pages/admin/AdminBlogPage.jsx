...
const ICON_KEYS = ['BookOpen', 'Shield', 'Map', 'Monitor', 'Server', 'Database', 'Cloud'];
const PRESETS = [
...
function BlogForm({ initial, onCancel, onSaved }) {
...
export default function AdminBlogPage() {
  ...
  const load = () => {
    setStatus('loading');
    listBlogPostsAdmin().then((data) => { setPosts(data); setStatus('ready'); }).catch(() => setStatus('error'));
  };
