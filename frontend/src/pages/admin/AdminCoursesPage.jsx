...
const ICON_KEYS = ['Monitor', 'Server', 'Shield', 'Smartphone', 'Database', 'Cloud', 'BookOpen'];
const LEVELS = [
...
function CourseForm({ initial, mentors, onCancel, onSaved }) {
...
export default function AdminCoursesPage() {
  ...
  const load = () => {
    ...
    Promise.all([listCoursesAdmin(), listMentors()])
      .then(([c, m]) => { setCourses(c); setMentors(m); setStatus('ready'); })
